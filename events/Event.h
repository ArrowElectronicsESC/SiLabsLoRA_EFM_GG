...
public:
    ...
    {
         static_cast<Event *>(func)->call(a0);
    }
...
public:
    ...
    Event(EventQueue *q, F f)
    {
        _event = static_cast<event *>(
                     equeue_alloc(&q->_equeue, sizeof(event) + sizeof(F)));
    ...
    {
         static_cast<Event *>(func)->call(a0, a1);
    }
...
public:
    ...
    {
         static_cast<Event *>(func)->call(a0, a1, a2);
    }
...
public:
    ...
    {
         static_cast<Event *>(func)->call(a0, a1, a2, a3);
    }
...
public:
    ...
    {
         static_cast<Event *>(func)->call(a0, a1, a2, a3, a4);
    }
