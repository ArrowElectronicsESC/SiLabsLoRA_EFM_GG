...
void LoRaWANStack::core_util_atomic_flag_clear(core_util_atomic_flag *flagPtr)
{
    flagPtr->_flag = false;
}

bool LoRaWANStack::core_util_atomic_flag_test_and_set(volatile core_util_atomic_flag *flagPtr)
{
